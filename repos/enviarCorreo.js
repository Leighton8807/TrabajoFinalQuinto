...
//   autenticar: {
//     user: 'correo@gmail.com', // Tu dirección de correo electrónico de Gmail
//     pass: '1235456fdrg', // Tu contraseña de Gmail
//   },
  ...
  db.query(query, [usuarioId], (err, result) => {
    if (err || result.length === 0) {
      ...
      const opcionesCorreo = {
        from: 'correo@gmail.com', // Tu dirección de correo electrónico (remitente)
